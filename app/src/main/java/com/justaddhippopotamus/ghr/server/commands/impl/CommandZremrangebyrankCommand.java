 ...
 */
public class CommandZremrangebyrankCommand extends ICommandImplementation {
    @Override
    public void runCommand(WorkItem item) {
        ...
        if( rss == null ) {
            ...
            rss.atomic( t ->
                    item.whoFor.queueInteger( rss.removeAll(rss.range(min,max,false,false,false,false,0,0,false)),item.order));
        }
    }
}
